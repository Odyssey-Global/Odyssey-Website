...
<body>
  ...
  <main id="content" role="main">
      ...
      <div class="container content-space-t-3">
        <div class="row justify-content-lg-between align-items-lg-center">
          <div class="col-lg-5 mb-5 mb-lg-0">
            <div class="mb-5">
              <p class="Hero-welcome">Welcome to Odyssey Global</p>
          ...
          <div class="col-lg-6">
            <div class="position-relative">
              <div class="position-relative">
                <img class="img-fluid" src="assets/img/hero.webp" alt="Image Description" />
              </div>
            </div>
          </div>
          <!-- End Col -->
    ...
    <!-- Icon Blocks -->
    <div class="job-cat-sec bg-dark">
      <div class="container">
        <div class="row">
          <div class="col-lg-3 mb-5">
            <div class="cat-text-clr job-cat-text">
              <h3>Job <br />Categories</h3>
            </div>
          </div>
          <!-- End Col -->
          <div class="col-lg-9 mb-5">
            <div class="row">
              ...
              <!-- <div class="col-sm-6 col-lg-4 mb-5">
                <div class="text-center text-white border-bottom border-white-10">
                  <p>Jobs in Education</p>
                </div>
              </div> -->
              <!-- <div class="col-sm-6 col-lg-4 mb-5">
                <div class="text-center text-white border-bottom border-white-10">
                  <p>Jobs in banking & finance</p>
                </div>
              </div> -->
              <div class="col-sm-6 col-lg-4 mb-5">
                <div class="text-white border-bottom border-white-10">
    ...
    <div class="container content-space-2 content-space-lg-3">
      <!-- Heading -->
      <div class="mb-5">
        <h2 class="fw400">Get more from your career</h2>
        <p>Join the people creating a one-stop shop for financial freedom.</p>
      </div>
      <!-- End Heading -->

      <div class="row row-cols-2 row-cols-lg-4 gx-2 gx-md-4">
        <div class="col mb-2 mb-md-4">
          ...
          <a class="card card-borderless card-transition-zoom bg-soft-blue h-100" href="#">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title">Contract Staffing</h4>
              <p>Flexibly hire top talent for critical projects on a short- and long-term basis.
              </p>
            </div>
          </a>
          <!-- End Card -->
        ...
        <div class="col mb-2 mb-md-4">
          ...
          <a class="card card-borderless card-transition-zoom bg-soft-blue h-100" href="#">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title">Contractor Payrolling</h4>
              <p>Manage risks, ensure compliance & take complexity out of contract payrolling.
              </p>
            </div>
          </a>
          <!-- End Card -->
        ...
        <div class="col mb-2 mb-md-4">
          ...
          <a class="card card-borderless card-transition-zoom bg-soft-blue h-100" href="#">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title">Temp to Perm</h4>
              <p>Evaluate and retain great talent from among temporary/ contractual employees.</p>
            </div>
          </a>
          <!-- End Card -->
        </div>
        ...
        <div class="col mb-2 mb-md-4">
          ...
          <a class="card card-borderless card-transition-zoom bg-soft-blue h-100" href="#">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title">Direct Hire</h4>
              <p>Find, recruit, and onboard exceptional, right fit candidates, removing guesswork.</p>
            </div>
          </a>
          <!-- End Card -->
        </div>
      ...
      <div class="container position-relative content-space-2 content-space-lg-3">
        <div class="row align-items-md-center mb-7">
          <div class="col-md-6 mb-3 mb-md-0">
            <h2 class="text-white fw400">Loved by business and individuals across the globe</h2>
          </div>
          <!-- End Col -->
        ...
        <!-- Swiper Slider -->
        <div class="swiper-center-mode-end mb-10">
          <div class="js-swiper-testimonials swiper swiper-equal-height">
            <div class="swiper-wrapper">
              <!-- Slide -->
              <div class="swiper-slide">
                <!-- Card -->
        ...
        <div class="row">
          <div class="col-6 col-md-4 mb-5 mb-md-0">
            ...
            <p class="text-white-70">in fulfilling orders</p>
          </div>
          <!-- End Col -->

          <div class="col-6 col-md-4 mb-5 mb-md-0">
            <h5 class="text-white">Startup businesses</h5>
            <span class="display-4 text-primary">2,000+</span>
            <p class="text-white-70">partner with Unify</p>
          </div>
          <!-- End Col -->

          <div class="col-6 col-md-4">
            <h5 class="text-white">Happy customer</h5>
            <span class="display-4 text-primary">85%</span>
            <p class="text-white-70">this year alone</p>
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
