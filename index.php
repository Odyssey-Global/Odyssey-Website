  ...
  <body>
    ...
    <main id="content" role="main">
            ...
            <div class="col-lg-5 mb-5 mb-lg-0">
              <div class="mb-5">
                ...
                <h1 class="display-4 text-light mb-5">
                  Your Premier
                  <span class="text-primaryt">Staffing Solution</span>
                </h1>
                <p class="fs-3">
              ...
              <div class="d-grid d-sm-flex gap-3 mb-5">
                <a class="btn btn-ghost-dark btn-pointer hero-btn" href="#"
                  >Find the right job today</a
                >
              </div>
            </div>
            <!-- End Col -->
          ...
          <div class="js-swiper-clients-1 swiper text-center">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img
                  class="avatar avatar-lg avatar-4x3"
                  src="assets/svg/brands/sass-dark.svg"
                  alt="Logo"
                />
              </div>
              <!-- End Slide -->
          ...
          <div class="row align-items-lg-center">
              ...
              <div class="row align-items-center">
                <div class="col-4">
                  <img
                    ...
                    src="assets/img/580x480/img1.jpg"
                    alt="Image Description"
                  />
                </div>
                <!-- End Col -->
                ...
                <div class="col-3">
                  <img
                    class="img-fluid rounded-3"
                    src="assets/img/350x700/img1.jpg"
                    alt="Image Description"
                  />
                </div>
                <!-- End Col -->
                ...
                <div class="col-5">
                  <img
                    class="img-fluid rounded-3"
                    src="assets/img/400x700/img1.jpg"
                    alt="Image Description"
                  />
                </div>
                <!-- End Col -->
            ...
            <div class="col-lg-5">
              <div class="mb-5">
                ...
                <a class="btn btn-ghost-dark btn-pointer border-button" href="#"
                  >Hire the right talent today</a
                >
              </div>
            </div>
            <!-- End Col -->
      ...
      <div class="container content-space-2 content-space-lg-3">
        <!-- Heading -->
        <div class="mb-5">
          <h2 class="fw400">From the Blog</h2>
          <p>
          ...
          <div class="col mb-5 mb-md-0">
            ...
            >
              <div class="card-pinned card-transition-zoom-item">
                <img
                  class="card-img"
                  src="assets/img/580x480/img2.jpg"
                  alt="Image Description"
                />              
              </div>
