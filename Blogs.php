  ...
  <main id="content" role="main">
    ...
    <div class="position-relative">
      ...
      <div class="js-swiper-blog-modern-hero swiper swiper-equal-height">
        ...
        <!-- Swiper Pagination -->
        <div
          class="js-swiper-blog-modern-hero-pagination swiper-pagination swiper-pagination-light position-absolute bottom-0 start-0 end-0 mb-3 d-sm-none">
        </div>
      </div>
      ...
      <div class="row justify-content-lg-between">
        <div class="col-lg-8 mb-10 mb-lg-0">
          <div class="d-grid gap-7 mb-7">
            ...
            <!-- Card -->
            <a class="card card-transition align-items-start flex-wrap flex-row bg-img-start" href="Blogs-articles.php"
              style="background-image: url(assets/img/900x450/img1.jpg); min-height: 25rem;">
              <!-- Card Header -->
              ...
              <div class="d-grid gap-3">
                ...
                <a class="d-block" href="Blogs-articles.php">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <h6 class="text-inherit mb-0">Mapping the first family tree for Odyssey office</h6>
                    </div>
                  </div>
                </a>
                <!-- End Card -->
