...
<body>
  ...
  <main id="content" role="main">
    <!-- Hero -->
    <div class="d-flex bg-img-center" style="background-color: #FFFC85;">
      <div class="container d-flex justify-content-end flex-column mmin-vh-lg-85 Career-banner">
        <div class="row">
          <div class="col-md-6">
    ...
    <div class="container">
      ...
      <div class="row justify-content-lg-between">
        ...
        <div class="col-sm-6 col-lg-5 mb-5">
          ...
          <div class="d-flex">
            <div class="flex-shrink-0">
              <i class="bi-cup fs-1 text-dark"></i>
            </div>
            <div class="flex-grow-1 ms-5">
        ...
        <div class="col-sm-6 col-lg-5 mb-5">
          ...
          <div class="d-flex">
            <div class="flex-shrink-0">
              <i class="bi-check2-circle fs-1 text-dark"></i>
            </div>
            <div class="flex-grow-1 ms-5">
              <h5>Learning and Development</h5>
              <p>Simple doesn’t equal easy. We’re intentional and focused—we believe in quality over quantity. We
                reduce ideas and solutions to their most seamless, elegant options.</p>
            </div>
          </div>
          <!-- End Icon Block -->
        </div>
    ...
    <div class="container-fluid career-cta-sec">
      <div class="row">
